...
class BERTClinVarEvaluator:
    ...
    def evaluate_dataset(self, dataset_path, output_dir='./bert_clinvar_evaluation_results', sample_size=None):
        """
    ...
    def _create_visualizations(self, results_df, output_dir):
        ...
        axes[0, 2].scatter(pathogenic_data['mlm_score'], pathogenic_data['cosine_similarity'], 
                          alpha=0.6, c='red', label='Pathogenic', s=20)
        axes[0, 2].scatter(benign_data['mlm_score'], benign_data['cosine_similarity'], 
        ...
        try:
            ...
            axes[1, 0].plot(fpr, tpr, label=f'MLM Score (AUC = {roc_auc_score(results_df["pathogenic"], results_df["mlm_score"]):.3f})')
