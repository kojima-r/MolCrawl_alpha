...
class COSMICVisualizationGenerator:
    ...
    def generate_class_distribution_plot(self):
        ...
        for i, v in enumerate(sizes):
            plt.text(i, v + max(sizes) * 0.01, str(v), ha='center', va='bottom', fontweight='bold')
    ...
    def generate_performance_radar_chart(self):
        ...
        plt.title('COSMIC Oncogenicity Prediction Performance Radar Chart', 
...
def main():
    ...
    parser.add_argument('--results_file', required=True, help='Path to COSMIC evaluation results JSON file')
    parser.add_argument('--output_dir', default='./cosmic_visualizations', help='Output directory for visualizations')
