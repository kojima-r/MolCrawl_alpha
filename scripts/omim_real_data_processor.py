...
class OMIMRealDataProcessor:
    ...
    def _estimate_pathogenicity(self, disorder: str) -> str:
        ...
        # 重篤な疾患キーワード
        severe_keywords = ['cancer', 'carcinoma', 'tumor', 'syndrome', 'disease', 
                          'deficiency', 'dystrophy', 'atrophy', 'degeneration']
    ...
    def generate_sequences_for_genes(self, gene_symbols: List[str], 
                                   sequence_length: int = 100) -> Dict[str, str]:
