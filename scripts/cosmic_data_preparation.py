...
class COSMICProcessor:
    ...
    def create_sample_cosmic_data(self, num_samples=20):
        ...
        # 既知の癌関連遺伝子と変異パターン
        cancer_genes = ['TP53', 'KRAS', 'PIK3CA', 'APC', 'BRCA1', 'BRCA2', 'EGFR', 'MYC']
        mutation_types = ['Substitution - Missense', 'Substitution - Nonsense', 'Deletion - Frameshift', 'Insertion - Frameshift']
