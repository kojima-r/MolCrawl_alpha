...
from utils.base import read_parquet, save_parquet, multiprocess_tokenization, setup_logging
...
if __name__ == "__main__":
    ...
    processed_organix13 = multiprocess_tokenization(scaffolds_tokenizer.bulk_tokenizer_parquet, processed_organix13, column_name="smiles", new_column_name="scaffold_tokens")
