...
try:
    ...
    tensorboard_dir = get_gpt2_output_path("rna", "yigarashi-2025-10-07")
    out_dir = get_gpt2_output_path("rna", "yigarashi-2025-10-07")
except ImportError:
    # Fallback if config.paths is not available
    tensorboard_dir = "gpt2-output/rna-yigarashi-2025-10-07"
    out_dir = "gpt2-output/rna-yigarashi-2025-10-07"
...
# Model architecture (smaller model for testing)
n_layer = 8
n_head = 8
n_embd = 512
bias = False
