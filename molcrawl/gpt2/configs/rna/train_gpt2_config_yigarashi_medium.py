...
try:
    ...
    tensorboard_dir = get_gpt2_output_path("rna", "yigarashi-2025-10-08-medium")
    out_dir = get_gpt2_output_path("rna", "yigarashi-2025-10-08-medium")
except ImportError:
    # Fallback if config.paths is not available
    tensorboard_dir = "gpt2-output/rna-yigarashi-2025-10-08-medium"
    out_dir = "gpt2-output/rna-yigarashi-2025-10-08-medium"
