...
const DATASETS = {
  ...
  molecule_nat_lang: {
    ...
    steps: [
      {
        id: 'download',
        name: 'SMolInstruct Dataset Download',
        marker: null,
        checkFiles: ['osunlp/SMolInstruct/raw/train', 'osunlp/SMolInstruct/data.zip'],
        outputDirs: ['osunlp/SMolInstruct'],
        outputFiles: ['data.zip', 'osunlp/SMolInstruct/README.md', 'osunlp/SMolInstruct/SMolInstruct.py'],
        description: 'HuggingFaceからSMolInstructデータセットをダウンロード（化学タスク指示データ）',
      },
      {
        id: 'tokenize',
        name: 'SMILES Validation & Tokenization',
        marker: null,
        ...
        description: 'SMILES構造を検証し、化学的に有効なサンプルをトークン化',
      },
      {
        id: 'arrow_format',
        name: 'BERT-Compatible Arrow Format',
        marker: null,
        checkFiles: ['arrow_splits/train.arrow', 'arrow_splits/valid.arrow'],
        outputDirs: ['arrow_splits'],
        outputFiles: ['arrow_splits/train.arrow/state.json', 'arrow_splits/valid.arrow/state.json', 'arrow_splits/test.arrow/state.json'],
        description: 'BERTトレーニング用にArrow形式で保存（個別サンプル維持）',
      },
      {
        id: 'gpt2_format',
        name: 'GPT-2-Compatible Token Stream',
        marker: null,
        checkFiles: ['gpt2_format/train.pt', 'gpt2_format/valid.pt'],
  ...
  compounds: {
    ...
    steps: [
      {
        id: 'download_zinc20',
        name: 'ZINC20 Dataset Download',
        marker: 'data/zinc20_download.marker',
        checkFiles: ['data/zinc20/download_results.csv'],
        outputDirs: ['data/zinc20'],
        description: '主要な化合物データソース（約1300万件）',
      },
      {
        id: 'download_opv',
        name: 'OPV Dataset Download',
        marker: 'data/opv_download.marker',
        checkFiles: ['data/opv/opv.parquet'],
        outputDirs: ['data/opv'],
        description: '有機太陽電池材料データ',
      },
      {
        id: 'download_llamol',
        name: 'LlaMol Datasets Download',
        marker: 'data/llamol_download.marker',
        checkFiles: ['data/Fraunhofer-SCAI-llamol/qm9_zinc250_cep.parquet'],
        outputDirs: ['data/Fraunhofer-SCAI-llamol'],
        description: 'Fraunhofer-SCAI/llamolリポジトリからのデータセット',
      },
      {
        id: 'combine',
        name: 'Datasets Integration',
        marker: 'organix13/download_complete.marker',
        checkFiles: ['organix13/OrganiX13.parquet'],
        outputDirs: ['organix13'],
        outputFiles: ['organix13/OrganiX13.parquet'],
        description: '全データセットを統合してOrganiX13を生成',
      },
      {
        id: 'tokenize',
        ...
        description: '化合物のSMILES記法とScaffoldsをトークン化',
      },
      {
        id: 'statistics',
        name: 'Statistics & Parquet Generation',
      ...
      {
        id: 'gpt2_prepare',
        name: 'GPT-2 Training Dataset Preparation (OrganiX13)',
        marker: null,
        checkFiles: ['organix13/compounds/training_ready_hf_dataset/train', 'organix13/compounds/training_ready_hf_dataset/valid'],
        outputDirs: ['organix13/compounds', 'organix13/compounds/training_ready_hf_dataset', 'organix13/compounds/training_ready_hf_dataset/train', 'organix13/compounds/training_ready_hf_dataset/valid', 'organix13/compounds/training_ready_hf_dataset/test'],
        outputFiles: [
          'organix13/compounds/training_ready_hf_dataset/dataset_dict.json',
          'organix13/compounds/training_ready_hf_dataset/train/dataset_info.json',
          'organix13/compounds/training_ready_hf_dataset/train/state.json',
          'organix13/compounds/training_ready_hf_dataset/valid/dataset_info.json',
          'organix13/compounds/training_ready_hf_dataset/valid/state.json',
          'organix13/compounds/training_ready_hf_dataset/test/dataset_info.json',
          'organix13/compounds/training_ready_hf_dataset/test/state.json',
        ],
