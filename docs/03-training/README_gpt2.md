...
- Genome Sequence:
  use `spm_tokenizer.model` generated by `molcrawl/preparation/preparation_script_genome_sequence.py`
  (path from `assets/configs/genome_sequence.yaml` -> `output_dir`)
- Compounds:
  use `vocab.txt` generated by `molcrawl/preparation/preparation_script_compounds.py`
