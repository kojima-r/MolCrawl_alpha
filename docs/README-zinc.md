...
```bash
python src/compounds/dataset/organix13/zinc/download_and_convert_to_parquet.py --status
```
...
python src/compounds/dataset/organix13/zinc/download_and_convert_to_parquet.py --download

# Download with custom delay to avoid server overload
python src/compounds/dataset/organix13/zinc/download_and_convert_to_parquet.py --download --delay 2.0
```

### 4. Convert to Parquet

```bash
python src/compounds/dataset/organix13/zinc/download_and_convert_to_parquet.py --convert /path/to/output/directory
```
...
python test_zinc_download_only.py

# Complete module test
python test_zinc_complete.py
```
